...
> Proxifly found **175** proxies from **50** countries in the latest update. Usable proxies are below.
...
You can also [get proxies by country](https://github.com/proxifly/free-proxy-list/tree/main/proxies/countries). There are currently **50** countries available.
