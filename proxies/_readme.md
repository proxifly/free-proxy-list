...
> Proxifly found **154** proxies from **45** countries in the latest update. Usable proxies are below.

## 🦄 Features
* ⚡ Extremely fast
* 📝 Validated every 10 minutes
* 🌎 Multiple countries
* 📓 Sorted into **HTTP**, **SOCKS4**, and **SOCKS5**
...
|-----|----|----|--|--|
|All Proxies|154|[JSON File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/all/data.json)|[Text File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/all/data.txt)|[CSV File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/all/data.csv)|
|HTTP Proxies|154|[JSON File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/protocols/http/data.json)|[Text File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/protocols/http/data.txt)|[CSV File](https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/protocols/http/data.csv)|
...
|Proxies by Country|45|[JSON File](https://github.com/proxifly/free-proxy-list/tree/main/proxies/countries)|[Text File](https://github.com/proxifly/free-proxy-list/tree/main/proxies/countries)|[CSV File](https://github.com/proxifly/free-proxy-list/tree/main/proxies/countries)|
